...
class seq3c_03(Scene):
    def construct(self):
        ...
        step02_txt = Tex('\\textbf{Déplacement} du Chameau de 400 mètres').scale(0.4).next_to(step01_txt, DOWN, aligned_edge=LEFT, buff = MED_SMALL_BUFF)
        self.add(step02_txt)
        ...
        step03_txt = Tex('\\textbf{Dépôt} de 200 bananes en (D1)').scale(0.4).next_to(step02_txt, DOWN, aligned_edge=LEFT, buff = MED_SMALL_BUFF)
        self.add(step03_txt)
        history_moves.append(step03_txt)
        self.play(
            cargo_value.animate.set_value(400),
            depots[1].animate.set_value(200),
        )
        ...
        step07_txt = Tex('\\textbf{Dépôt} de 200 bananes en (D1)').scale(0.4).next_to(step06_txt, DOWN, aligned_edge=LEFT, buff = MED_SMALL_BUFF)
        self.add(step07_txt)
        history_moves.append(step07_txt)
        self.play(
            cargo_value.animate.set_value(400),
            depots[1].animate.set_value(depots[1].get_value() + 200),
        )
        ...
        step11_txt = Tex('\\textbf{Chargement} de 400 bananes de (D1) vers le Chameau').scale(0.4).next_to(step10_txt, DOWN, aligned_edge=LEFT, buff = MED_SMALL_BUFF)
        self.add(step11_txt)
        ...
        step12_txt = Tex('\\textbf{Déplacement} du Chameau de 1000 mètres').scale(0.4).next_to(dummy12txt, DOWN, aligned_edge=LEFT, buff = MED_SMALL_BUFF)
        self.add(step12_txt)
        ...
        self.play(Unwrite(camel_cargo_txt), Transform(camel, final_camel_pos), Write(fcp_txt))
        self.wait()
